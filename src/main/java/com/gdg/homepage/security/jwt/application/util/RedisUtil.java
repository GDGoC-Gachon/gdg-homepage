...
import com.gdg.homepage.security.jwt.domain.repository.JwtTokenRedisRepository;
...
public class RedisUtil {
    ...
    /// 존재 여부 체크
    public boolean checkRefreshTokenAndUserId(String refreshToken, Long userId) {
