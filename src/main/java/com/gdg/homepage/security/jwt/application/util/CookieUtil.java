...
import static com.gdg.homepage.security.jwt.application.util.TokenNameUtil.ACCESS_TOKEN_COOKIE_NAME;
import static com.gdg.homepage.security.jwt.application.util.TokenNameUtil.REFRESH_TOKEN_COOKIE_NAME;
...
public class CookieUtil {
    ...
    @Value("${gdg.jwt.access.expiration}")
    private Long accessTokenExpiration;

    @Value("${gdg.jwt.refresh.expiration}")
    private Long refreshTokenExpiration;

    @Value("${gdg.auth.jwt.secureOption}")
    private boolean secureOption;

    @Value("${gdg.auth.jwt.sameSiteOption}")
    private String sameSiteOption;

    @Value("${gdg.auth.jwt.cookiePathOption}")
