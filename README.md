...
시스템은 3단계 권한 구조를 가지고 있습니다:

| 권한 | 역할 | 설명 |
|------|------|------|
| `MEMBER` | 일반 회원 | 기본 회원 권한 |
| `TEAM_MEMBER` | 팀 멤버 | MEMBER 권한 + 팀 관련 기능 |
| `ORGANIZER` | 운영진 | 전체 관리자 권한 (회원 관리, 가입 기간 관리, 통계 조회) |

> **권한 계층**: ORGANIZER > TEAM_MEMBER > MEMBER
